...
document.querySelector('.portifolio_popup-close').addEventListener('click', togglePortifolioPopup)

function portifolioItemDetails(portifolioItem) {
    document.querySelector('.pp_thumbnail img').src = portifolioItem.querySelector('.work_img').src;
    document.querySelector('.portifolio_popup-subtitle span').innerHTML = portifolioItem.querySelector('.work_title').innerHTML;
    document.querySelector('.portifolio_popup-body').innerHTML = portifolioItem.querySelector('.portifolio_item-details').innerHTML;
}
